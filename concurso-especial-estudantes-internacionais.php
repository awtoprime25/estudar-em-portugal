...
<main id="conteudo">
  ...
  <section class="content-block content-block--wide">
    ...
    <p>É o processo de inscrição (candidatura, no termo oficial português) criado pelo governo português (Decreto-Lei n.º 36/2014) para quem não tem nacionalidade portuguesa nem de outro país da União Europeia. Funciona separado do concurso nacional que os alunos portugueses disputam: as vagas são reservadas, os critérios de avaliação são diferentes, e cada universidade ou instituto politécnico organiza o seu próprio processo, dentro de um calendário nacional de referência.</p>
    ...
    <ul>
      ...
      <li>Paga a mensalidade de estudante internacional, ou propina, no termo oficial português (mais alta, mas com possível desconto CPLP — veja abaixo).</li>
    </ul>
    ...
    <ul>
      ...
      <li>Paga a mensalidade de estudante nacional/UE, bem mais barata que a de internacional.</li>
    </ul>
    ...
    <ul>
      ...
      <li>A mensalidade é bem mais alta, mesmo com o desconto CPLP;</li>
    ...
    <ol>
      ...
      <li>Inscrição online — feita na plataforma da própria instituição, dentro do prazo da fase escolhida (a maioria das universidades abre de 2 a 3 fases ao longo do ano).</li>
      <li>Envio de documentos — upload dos documentos digitalizados dentro do prazo.</li>
      <li>Validação e ordenação das inscrições — a instituição avalia a documentação e ordena os candidatos, normalmente com base na nota do ENEM ou em prova equivalente.</li>
      ...
      <li>Matrícula definitiva — com entrega dos documentos originais e pagamento da mensalidade.</li>
    </ol>
    <p>Depois de aprovado, ainda é preciso tratar do <a href="visto-de-estudante.php">visto de estudante</a> junto ao consulado português no Brasil, e, já em Portugal, regularizar a residência junto à AIMA (Agência para a Integração, Migrações e Asilo).</p>

    <h2 id="quanto-custa">Quanto custa</h2>
    <p>A mensalidade de estudante internacional é mais alta do que a de um aluno nacional, variando bastante por curso e instituição — em algumas faculdades vai de cerca de 3.500€ a mais de 16.000€ por ano.</p>
    ...
    <div class="warning-box">
      <ul style="margin:0;">
        <li>Perder o prazo da fase de inscrição — não há tolerância;</li>
        ...
        <li>Confundir o desconto CPLP com bolsa de estudos — é redução na mensalidade, não é dinheiro para viver;</li>
    ...
    <p><strong>Da Vinci</strong> acompanha o aluno na etapa acadêmica: orientação sobre qual curso e instituição combinam com o perfil e a nota do ENEM do candidato, apoio na organização do histórico escolar e na equivalência de disciplinas, e preparação para os requisitos específicos de cada curso (como provas de pré-requisito em algumas áreas).</p>
    <p><strong>StudyWing</strong> cuida da parte de aconselhamento e conexão com a universidade: apoio na escolha entre as opções disponíveis, orientação sobre prazos e fases de inscrição, e uma consultoria gratuita para tirar dúvidas antes de decidir.</p>
