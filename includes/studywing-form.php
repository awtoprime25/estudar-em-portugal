    ...
    <div class="container">
      <div class="formulario-grid">
        <div class="formulario-intro">
          ...
          <h2>Fale diretamente com um consultor StudyWing</h2>
          <p>Preencha os passos abaixo e a equipe StudyWing entra em contato por email ou WhatsApp em menos de 24 horas. Tudo gratuito, sem compromisso.</p>
        ...
        <form id="studywing-form" class="studywing-form" action="ajax-comp.php" method="POST" novalidate data-studywing>
          ...
          <fieldset class="studywing-step" data-step="2">
            ...
            <div class="studywing-grid">
              <label class="studywing-grid--full">
                <span>O que você procura, no fundo? *</span>
              ...
              <label>
                <span>Que tipo de formação você procura? *</span>
              ...
              <label>
                <span>Que curso você pretende estudar/reconhecer em Portugal? *</span>
                <input type="text" name="areas" placeholder="Medicina, Engenharia Informática, Gestão…" required>
              </label>
              <label class="studywing-grid--full">
                <span>Quando você pretende estar em Portugal? *</span>
          ...
          <fieldset class="studywing-step" data-step="3">
            ...
            <div class="studywing-grid">
              <label class="studywing-grid--full">
                <span>Qual o seu grau de escolaridade atual? *</span>
              ...
              <label class="studywing-grid--full">
                <span>Contando ~1.000€/mês de custo de vida em Portugal, como você está neste momento? *</span>
                <select name="situacao_financeira" required>
                  <option value="">Escolha…</option>
                  <option value="garantido">Já tenho esse valor garantido</option>
                  <option value="a-juntar">Estou juntando, mas ainda não tenho tudo</option>
              ...
              <label class="studywing-grid--full">
                <span>Como você pensa pagar os estudos e a estadia? *</span>
          ...
          <fieldset class="studywing-step" data-step="4">
            ...
            <div class="studywing-grid">
              ...
              <div class="studywing-grid--full studywing-radio-group">
                <span class="studywing-radio-group__label">Em que fase você está? *</span>
